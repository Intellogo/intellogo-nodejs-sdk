...
/**
 * Sets up a local web service that provides an better alternative for the task polling mechanism.
 ...
 * @callback [callback] A callback that will be called when the service is up and running.
 */
 ...
 * interval.
 * @callback [callback] An optional callback that will be called once the web service
 * has been stopped.
 */
