...
function IntellogoClient (options) {
    ...
    var decorators = [callbackify];
    mergeFns(this, TrainingAPI.prototype, decorators);
    mergeFns(this, ContentAPI.prototype, decorators);
    mergeFns(this, SmartCollectionsAPI.prototype, decorators);
    mergeFns(this, InsightsAPI.prototype, decorators);
    mergeFns(this, RecommendationsAPI.prototype, decorators);
}
