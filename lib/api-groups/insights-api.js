 ...
 * Use {@link InsightsAPI#setInsightsSamples} for them instead.
 *
 ...
 * @param {Array.<InsightsAPI~SamplesUpdate>} insightsWithSamples
 * @param {IntellogoCallback.<InsightsAPI~SuccessResponse[]>} [callback]
 * @return {IntellogoResponse.<InsightsAPI~SuccessResponse>}
 * @method
 */
...
/**
 * Unassign samples or testSamples from an insight. <br>
 * To unassign samples, either use {@link InsightsAPI#unassignInsightsSamples}, or replace all
 * insight samples with {@link InsightsAPI#setInsightsSamples}
 * @param {Array.<InsightsAPI~SamplesUpdate>} insightsWithSamples
 * @param {IntellogoCallback.<InsightsAPI~SuccessResponse[]>} [callback]
 * @return {IntellogoResponse.<InsightsAPI~SuccessResponse>}
 * @method
