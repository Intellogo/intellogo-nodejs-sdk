...
/**
 * @typedef {Object} InsightsAPI~Sample
 ...
 * @property {Array.<InsightsAPI~Sample>} samples
 * @property {Array.<InsightsAPI~Sample>} testSamples
 */
...
/**
 * Api call for updating an array of insight objects. Note that samples and testSamples are not updated by this call.
...
/**
 * Override samples or testSamples of insight object.
 *
 * @param {Array.<InsightsAPI~SamplesUpdate>} options
 * @param {IntellogoCallback.<InsightsAPI~Insight[]>} [callback]
 * @return {IntellogoResponse.<InsightsAPI~Insight>}
 * @method
 */
InsightsAPI.prototype.setInsightsSamples = callbackify(
    function (options) {
        ...
        let data = this.webBridge.buildPostData(requestData);

        return this.webBridge.post('/api/categories/samples/update', data, {}, false);
    }
);
