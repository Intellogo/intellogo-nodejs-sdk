    ...
    Insight() {
        let that = this,
            insightClass = class extends Model {
                        ...
                        that.api.getInsightsSamples(
                            ...
                            modelMethodResponse(
                                ...
                                (insight, insightArr) => {
                                    ...
                                    let transform = _.map(insightArr[0].samples,
                                        (sample) => {
                                            return {
                                                content: new that.api.classes.Content(_.merge(sample, {_id: sample.contentId})),
                        ...
                        that.api.getInsightsTestSamples(
                            ...
                            modelMethodResponse(
                                ...
                                (insight, insightArr) => {
                                    ...
                                    let transform = _.map(insightArr[0].testSamples,
                                        (sample) => {
                                            return {
                                                content: new that.api.classes.Content(_.merge(sample, {_id: sample.contentId})),
                                                positive: sample.positive
                ...
                toPlainObject() {
                    // TODO: refactor this
                    let simpleProperties = super.toPlainObject();
                    simpleProperties.samples = this.samples.toArray();
                    simpleProperties.testSamples = this.testSamples.toArray();
