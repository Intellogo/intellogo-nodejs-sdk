...
// Needed because 'arguments' is not an instance of Array,
// although it has a length property
function sliceArgs (args, from, to) {
    ...
    return function () {
        ...
        if (callback && typeof callback === 'function') {
            var intellogoResponse =
                fn.apply(this, sliceArgs(arguments, 0, arguments.length -1));
